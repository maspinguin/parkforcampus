...
#define RST_PIN         5           // Configurable, see typical pin layout above 5
#define SS_PIN          53         // Configurable, see typical pin layout above 53
#define SS_PIN_2          45          // Configurable, see typical pin layout above

constexpr uint8_t NR_OF_READERS = 2;

byte ssPins[] = {SS_PIN, SS_PIN_2};
byte readedCard[NR_OF_READERS][4];
...
//    
//    Serial.println(F("Authenticating using key A..."));
//    status = (MFRC522::StatusCode) mfrc522_2.PCD_Authenticate(MFRC522::PICC_CMD_MF_AUTH_KEY_A, trailerBlock, &keyA , &(mfrc522.uid));
//    if (status != MFRC522::STATUS_OK) {
//        Serial.print(F("PCD_Authenticate() failed: "));
...
//
//    Serial.println(F("Authenticating again using key B..."));
//    status = (MFRC522::StatusCode) mfrc522_2.PCD_Authenticate(MFRC522::PICC_CMD_MF_AUTH_KEY_B, trailerBlock, &keyB, &(mfrc522.uid));
//    if (status != MFRC522::STATUS_OK) {
//        Serial.print(F("PCD_Authenticate() failed: "));
//        Serial.println(mfrc522_2.GetStatusCodeName(status));
//        return;
